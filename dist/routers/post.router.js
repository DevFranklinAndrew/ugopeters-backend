...
router.post("/", auth_middleware_1.protect, writeLimiter, postController.createPost);
router.patch("/:id", auth_middleware_1.protect, writeLimiter, postController.updatePost);
router.delete("/:id", auth_middleware_1.protect, writeLimiter, postController.deletePost);
