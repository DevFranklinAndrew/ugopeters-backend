...
router.get("/", auth_middleware_1.protect, messageController.listMessages);
router.patch("/:id", auth_middleware_1.protect, writeLimiter, messageController.markMessageRead);
router.delete("/:id", auth_middleware_1.protect, writeLimiter, messageController.deleteMessage);
